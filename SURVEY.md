...
All questions were answered anonymously and processed in aggregate. Only the questionnaire is published here:
...
Q35. Criticality of the following wireless vectors (arate each one):
DSRC
Telematics
TPMS
Wi-Fi
